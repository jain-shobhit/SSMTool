function prob = ode_PD2PD(prob, oid, varargin)
%ODE_PD2PD   Start continuation of period-doubling bifurcation points.
%
% PROB = ODE_PD2PD(PROB, OID, VARARGIN)
...
% toolbox function to start a continuation of period-doubling bifurcation
% points. See the documentation of toolboxes of the toolbox family ODE for
% information about which toolboxes support period-doubling continuation.
%
% See also: ODE_PO2PD
