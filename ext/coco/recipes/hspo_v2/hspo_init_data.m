...
% function objects.
%
% Differs from hspo_v1 by the construction of toolbox data particular to the
% detection of Neimark-Sacker bifurcations (and neutral saddles).
%
...
data.la_idx1 = A(I); % Index array used by Neimark-Sacker monitor function
A            = A';
data.la_idx2 = A(I); % Index array used by Neimark-Sacker monitor function
