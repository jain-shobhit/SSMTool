...
%
% Differs from to alg_v9 by the inclusion of an optional setting for
% detecting neutral saddle points.
%
...
defaults.NSad = false; % Don't locate neutral saddle points.
