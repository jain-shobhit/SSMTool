...
% mesh distribution).
%
% Differs from coll_v4 by eliminating data associated with the comoving
% mesh algorithm and providing support for adaptive remeshing.
%
...
maps.xtr     = [maps.xbp_idx; maps.Tp_idx]; % Index array for invariant elements
