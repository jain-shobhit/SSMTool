...
% Version:  4.0
% 
% Source:   Sect. 18.3.3 of Recipes for Continuation
%
...
%   <a href="matlab:coco_recipes_edit coll_v4 coll_isol2seg">coll_isol2seg</a>      - Append 'coll' instance constructed from initial
%                        data.
%   <a href="matlab:coco_recipes_edit coll_v4 coll_sol2seg">coll_sol2seg</a>       - Append 'coll' instance constructed from saved data.
%   <a href="matlab:coco_recipes_edit coll_v4 coll_construct_seg">coll_construct_seg</a> - Append an instance of 'coll' to problem.
%
% Toolbox instance functions
%   <a href="matlab:coco_recipes_edit coll_v4 coll_construct_seg>coll_F">coll_construct_seg>coll_F</a>    - Collocation zero problem.
%   <a href="matlab:coco_recipes_edit coll_v4 coll_construct_seg>coll_DFDU">coll_construct_seg>coll_DFDU</a> - Linearization of collocation zero
%                                  problem.
%   <a href="matlab:coco_recipes_edit coll_v4 coll_construct_seg>coll_err">coll_construct_seg>coll_err</a>  - Evaluate estimate of approximation eror.
%   <a href="matlab:coco_recipes_edit coll_v4 coll_construct_seg>coll_update">coll_construct_seg>coll_update</a> - Update reference warping coefficients and arclengths.
%   <a href="matlab:coco_recipes_edit coll_v4 coll_construct_seg>coll_update_h">coll_construct_seg>coll_update_h</a> - Update step size of mesh condition.
%
% Toolbox utility functions
%   <a href="matlab:coco_recipes_edit coll_v4 coll_arg_check">coll_arg_check</a>     - Basic argument checking for 'coll' toolbox.
%   <a href="matlab:coco_recipes_edit coll_v4 coll_get_settings">coll_get_settings</a>  - Read 'coll' toolbox instance settings.
%   <a href="matlab:coco_recipes_edit coll_v4 coll_init_data">coll_init_data</a>     - Initialize toolbox data for an instance of 'coll'.
%   <a href="matlab:coco_recipes_edit coll_v4 coll_interval">coll_interval</a>      - Initialize data defining a collocation interval.
%   <a href="matlab:coco_recipes_edit coll_v4 coll_interval>coll_nodes">coll_interval>coll_nodes</a> - Compute collocation nodes and integration
%                               weights.
%   <a href="matlab:coco_recipes_edit coll_v4 coll_interval>coll_L">coll_interval>coll_L</a>     - Vectorized evaluation of Lagrange
%                               polynomials.
%   <a href="matlab:coco_recipes_edit coll_v4 coll_interval>coll_Lp">coll_interval>coll_Lp</a>    - Vectorized evaluation of derivative of
%                               Lagrange polynomials.
%   <a href="matlab:coco_recipes_edit coll_v4 coll_interval>coll_Lm">coll_interval>coll_Lm</a>     - Compute highest order coefficient of Lagrange polynomial.
%   <a href="matlab:coco_recipes_edit coll_v4 coll_maps">coll_maps</a>          - Initialise data depending on order but not on mesh distribution.
%   <a href="matlab:coco_recipes_edit coll_v4 coll_mesh">coll_mesh</a>          - Initialise data depending on order and mesh distribution.
%   <a href="matlab:coco_recipes_edit coll_v4 coll_init_sol">coll_init_sol</a>      - Build initial solution guess.
%   <a href="matlab:coco_recipes_edit coll_v4 coll_read_solution">coll_read_solution</a> - Read 'coll' solution and toolbox data from disk.
%
% Toolbox data (struct)
...
%   <a href="matlab:coco_recipes_edit coll_v4 coco_rm_this_path">coco_rm_this_path</a> - Remove toolbox from search path.
%
% See also <a href="matlab: coco_recipes_doc coll_v4_demo coll_v4_demo">coll_v4_demo</a>
