function figure_20_18
% Figure 20.18: Discretization of the canard orbit in Fig. 20.14(g)
% obtained using continuation with the moving-mesh method with adaptive discretization order from Sect.
% 20.2.2 on a mesh with NTST equal to 66, NCOL equal to 4, and TOL equal to
% 10^(-4). The fat dots in (a) and the open circles in
% (b) mark the end points of mesh intervals. The estimated discretization
% error of this solution is 1.1882*10^(-5).
