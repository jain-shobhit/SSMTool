...
%
% Differs from alg_v7 by the inclusion of an additional monitor function
% for Hopf bifurcation point detection and location.
%
...
if data.alg.HB % Optional monitor function for Hopf bifurcation detection
  ...
  prob = coco_add_event(prob, 'HB', fid_HB, 0); % HB - event type
end
...
% Identical to alg_v7.
%
% see also <a href="matlab:coco_recipes_edit alg_v9 alg_construct_eqn alg_update">alg_construct_eqn>alg_update</a>.
