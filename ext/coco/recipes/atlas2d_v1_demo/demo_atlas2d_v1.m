% bug: add visualisation of continuation path.

coco_use_recipes_toolbox atlas2d_v1 % Add atlas2d_v1 atlas algorithm to search path
...
% algorithm again terminates prematurely after covering only half the
% sphere. The coverage appears highly redundant.
...
prob = coco_set(prob, 'cont', 'Ndirs', 4, 'PtMX', 300); % Number of available directions = 4
...
coco_use_recipes_toolbox % Remove atlas2d_v1 atlas algorithm from search path
