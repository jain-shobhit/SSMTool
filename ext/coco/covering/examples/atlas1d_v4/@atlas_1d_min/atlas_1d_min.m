classdef atlas_1d_min < AtlasBase
  ...
  % projection condition and predictor. The algorithm performs continuation
  % in each direction along the solution manifold until the boundary of the
  % computational domain is reached or the maximum number of steps is
  % reached.
  
  % Copyright (C) Frank Schilder, Harry Dankowicz
  % $Id: atlas_1d_min.m 3114 2019-06-09 01:19:10Z hdankowicz $
