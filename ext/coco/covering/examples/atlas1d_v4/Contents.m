...
% and predictor. The algorithm performs continuation in each direction
% along the solution manifold until the boundary of the computational
% domain is reached or the maximum number of steps is reached. The
...
%
% See also <a href="matlab: doc ../atlas1d_v4_demo/Contents.m">atlas1d_v4_demo</a>
