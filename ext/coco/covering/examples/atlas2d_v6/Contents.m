...
% redundant coverage, implements a recursive merger inwards from the
% boundary, and maintains a record of a polygonal boundary, in order to
% prevent premature termination. The algorithm generalizes the source in
% Recipes for Continuation by providing support for a projected geometry
% onto a subset of elements of the vector of continuation variables.
%
% Class directories
...
%   <a href="matlab: edit @atlas_2d_min/init_chart">init_chart</a>      - Initialize chart.
%   <a href="matlab: edit @atlas_2d_min/init_admissible">init_admissible</a> - Remove inadmissible directions.
...
%
% See also <a href="matlab: doc ../atlas2d_v6_demo/Contents.m">atlas2d_v6_demo</a>

% Copyright (C) Frank Schilder, Harry Dankowicz
% $Id: Contents.m 3124 2019-06-12 01:50:23Z hdankowicz $
