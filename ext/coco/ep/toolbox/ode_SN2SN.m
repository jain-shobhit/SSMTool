function prob = ode_SN2SN(prob, oid, varargin)
%ODE_SN2SN   Start continuation of saddle-node bifurcation points.
%
% PROB = ODE_SN2SN(PROB, OID, VARARGIN)
...
% toolbox function to start a continuation of saddle-node bifurcation
% points. See the documentation of toolboxes of the toolbox family ODE for
% information about which toolboxes support saddle-node continuation.
%
% See also: ODE_EP2SN, ODE_PO2SN

% Copyright (C) Frank Schilder, Harry Dankowicz
% $Id: ode_SN2SN.m 2894 2015-10-02 15:05:02Z hdankowicz $
