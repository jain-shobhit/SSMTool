function y = spring_ode(t,x,p,type)
...
F1 = 2*zeta1*om1*v1+om1^2*x1+0.5*om1^2*(3*x1.^2+x2.^2+x3.^2)+om2^2*x1.*x2+...
    +om3^2*x1.*x3+omav*x1.*(x1.^2+x2.^2+x3.^2);
F2 = 2*zeta2*om2*v2+om2^2*x2+0.5*om2^2*(3*x2.^2+x1.^2+x3.^2)+om1^2*x1.*x2+...
    +om3^2*x2.*x3+omav*x2.*(x1.^2+x2.^2+x3.^2);
F3 = 2*zeta3*om3*v3+om3^2*x3+0.5*om3^2*(3*x3.^2+x1.^2+x2.^2)+om1^2*x1.*x3+...
